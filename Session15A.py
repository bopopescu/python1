...
anotherCustomer = Customer("Fionna", "+91 99877 12365", "fionna@example.com")
anotherDriver = Driver("Leo", "+91 98000 99000", "leo@example.com", "MN3123AXC")
...
anotherRide = Ride(anotherCustomer)
anotherRide.selectSourceAndDestination()
anotherRide.selectCab()
anotherRide.attachDriver(anotherDriver)
anotherRide.showRideDetails()

# Draw memory Representation for Objects :)
