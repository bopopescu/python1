...
#please see: if you create functions with same name again and again
#you will get same hashcodes
#but ypu will get no errors
#old fnc is deleted and new function is created
